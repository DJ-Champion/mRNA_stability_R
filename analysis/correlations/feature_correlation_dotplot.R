...
feature_correlation_dotplot <- function(df,
  ...
  # Facet ordering: supergroup panels ordered by the max |correlation| any of
  # their stems achieves, so the panel containing the strongest signal sits
  # first. Mirrors the within-facet stem ordering.
